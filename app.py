    ...
    for i in range(len(transactions)):
        ...
        if isinstance(current_transaction, dict) and 'signature' in current_transaction:
            ...
            try:
                ...
                return "La signature de la transaction " + str(i) + " est incorrecte" + " les signatures sont : "+str(current_transaction['signature'])+" et "
            + str(bytes.fromhex(current_transaction['signature']))+" et " + str(pubkey)
        else:
